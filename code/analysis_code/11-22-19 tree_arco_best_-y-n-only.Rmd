...
#new_wq <- new_wq %>% mutate(arco_y_n= 
                      ...
                      #"negative"))
as.factor(new_wq$A_butzleri_HSP60)
new_wq <- new_wq %>% mutate(acro_y_n= recode(A_butzleri_HSP60, 
                                             ("3.391993" = "negative")))
clean_data_1 <- new_wq
...
Tree #5 
Okay, let's try to change our measure from ACC to RMSE and see what that does. Im going to try it with how the data was in the first data set to start. 
