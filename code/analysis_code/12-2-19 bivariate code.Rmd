...
png("../../results/thermo_pond_table.rds", height=400, width=400)
...
McCall_Title <- expression(paste("Water Quality Failures in McCall Lake"))
                           
McCall_entero_percent_bar <- grid.arrange(ML2_Entero_percent_bar, ML1_entero_percent_bar, PR60_entero_percent_bar, Inlet_.75_entero_percent_bar, top=textGrob(McCall_Title, gp=gpar(fontsize=9,font=8)), nrow=2)
...
Country_sites_percent_bar <- grid.arrange( WP31A_entero_percent_bar, WP31B_entero_percent_bar, WP31C_entero_percent_bar, WP31D_entero_percent_bar, WP31E_entero_percent_bar, top = "Water Quality Failures in Country Hills" , nrow=2)
...
Inverness_sites_percent_bar <- grid.arrange(outfall_inlet_entero_percent_bar, WP26B_entero_percent_bar, WP26C_entero_percent_bar, WP26D_entero_percent_bar, top = "Water Quality Failures in Inverness" , nrow=2)
ggsave(filename = "../../results/Inverness_entero_percent_bar_sampling_site.png",plot = Inverness_sites_percent_bar)

#arrange them all together
sites_percent_bar <- grid.arrange(ML2_Entero_percent_bar, ML1_entero_percent_bar, PR60_entero_percent_bar, Inlet_.75_entero_percent_bar, WP31A_entero_percent_bar, WP31B_entero_percent_bar, WP31C_entero_percent_bar, WP31D_entero_percent_bar, WP31E_entero_percent_bar, outfall_inlet_entero_percent_bar, WP26B_entero_percent_bar, WP26C_entero_percent_bar, WP26D_entero_percent_bar, top = "Water Quality Failures by Sampling Site" , nrow=4)
...
all_percent_bar <- grid.arrange(McCall_arco_percent_bar, Country_arco_percent_bar, Inverness_arco_percent_bar, McCall_campy_percent_bar, Country_campy_percent_bar, Inverness_campy_percent_bar, McCall_sal_percent_bar, Country_sal_percent_bar, Inverness_sal_percent_bar, nrow = 3, top= "Pathogens in Stormwater Ponds")
ggsave(filename = "../../results/all_percent_bar.png",plot = all_percent_bar)


arco_percent_bar <- grid.arrange(McCall_arco_percent_bar, Country_arco_percent_bar, Inverness_arco_percent_bar, top= "Pathogens in Stormwater Ponds")
ggsave(filename = "../../results/arco_percent_bar.png",plot = arco_percent_bar)

campy_percent_bar <- grid.arrange(McCall_campy_percent_bar, Country_campy_percent_bar, Inverness_campy_percent_bar, top= "Pathogens in Stormwater Ponds")
ggsave(filename = "../../results/campy_percent_bar.png",plot = campy_percent_bar)

Sal_percent_bar <- grid.arrange( McCall_sal_percent_bar, Country_sal_percent_bar, Inverness_sal_percent_bar, top= "Pathogens in Stormwater Ponds")
ggsave(filename = "../../results/sal_percent_bar.png",plot = Sal_percent_bar)
```
...
Let's look at correlation using a two way table first. We will try some other methods also, and see which one we like the best. Two way tables are limiting in some aspects (number of variables) that are corrplot is not. 
...
CORRELATION
It is important to see what microbials source tracking markers are correlated to _A. butlzeri_ occurance to try to determine the source of the pathogen. We will use the corrplot package to do so.
```{r corrplot attempt 1}
library(corrplot)
library(ggplot2)
