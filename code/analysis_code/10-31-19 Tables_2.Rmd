...
png("../../results/arco_site_3_table.png", height=400, width=400)
p<-tableGrob(arco_site_3)
grid.arrange(p)
dev.off()
...
```{r}
#Lets took at by pond
xtabs(~Pond+Salmonella_y_n, data=new_wq)
Salmonella_pond_table<- rowPerc(xtabs(~Pond+Salmonella_y_n, data=new_wq))
png("../../results/salmonella_pond_table.png", height=400, width=400)
p<-tableGrob(Salmonella_pond_table)
grid.arrange(p)
dev.off()


xtabs(~Pond+arco_y_n, data=new_wq)
Arco_pond_table<- rowPerc(xtabs(~Pond+arco_y_n, data=new_wq))
png("../../results/arco_pond_table.png", height=400, width=400)
p<-tableGrob(Arco_pond_table)
grid.arrange(p)
dev.off()

xtabs(~Pond+Campy_y_n, data=new_wq)
campy_pond_table<- rowPerc(xtabs(~Pond+Campy_y_n, data=new_wq))
png("../../results/campy_pond_table.png", height=400, width=400)
p<-tableGrob(campy_pond_table)
grid.arrange(p)
dev.off()


all_table <- knitr::kable(list(campy_pond_table, Salmonella_pond_table))
png("../../results/all_table.png", height=400, width=400)
p<-tableGrob(all_table)
grid.arrange(p)
dev.off()
##grid.arrange(campy_pond_table, Salmonella_pond_table, Arco_pond_table, nrow=2)
```
