...
dataWQ$A_butlzeri_HSP60[which(dataWQ$A_butlzeri_HSP60=="DNQ")] <- "4932"
...
A_butlzeri_HSP60_A <- na_replace(dataWQ$A_butlzeri_HSP60, 2466)
...
dataWQ$A_butlzeri_HSP60 <- na_replace(dataWQ$A_butlzeri_HSP60, 2466)
dataWQ$Salmonella_spp_InvA <- na_replace(dataWQ$Salmonella_spp_InvA, 1482)
dataWQ$Campylobacter_spp_Van_Dkye <- na_replace(dataWQ$Campylobacter_spp_Van_Dkye,35880)
...
shapiro.test(cleandata$HF183)
shapiro.test(cleandata$HumM2)
shapiro.test(cleandata$CG01)
shapiro.test(cleandata$LeeSg)
shapiro.test(cleandata$Dog3)
shapiro.test(cleandata$MuBac)
shapiro.test(cleandata$Rum2Bac)
shapiro.test(cleandata$A_butlzeri_HSP60)
shapiro.test(cleandata$Salmonella_spp_InvA)
shapiro.test(cleandata$Campylobacter_spp_Van_Dkye)
shapiro.test(cleandata$MuBac)
