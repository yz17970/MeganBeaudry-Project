...
```{r}
knitr::include_graphics("../../results/HF183_boxplots_all_ponds.png")
```
...
One potential environmental variable examined was antecedent rainfall. Only three dates (i.e., May 25th, June 8th, and September 13th) had greater than 10 mm of rain. Seagull fecal contamination was detected on only one of the sampling dates (September 13th), though at three sampling sites on this date. (*MUST ADD RAINFALL INFO*)
